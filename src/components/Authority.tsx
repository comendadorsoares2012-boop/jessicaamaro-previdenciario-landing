...
const Authority = () => {
  return (
    <section className="py-20 lg:py-32 bg-brand-green">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="font-body text-base md:text-lg text-primary-foreground/70 leading-relaxed mb-6">
              <strong className="text-primary-foreground">Jéssica Amaro</strong> é advogada com atuação nas áreas de Direito Previdenciário e do Consumidor, com experiência em cálculos de benefícios do INSS e na defesa dos direitos dos consumidores.
            </p>
            <p className="font-body text-base md:text-lg text-primary-foreground/70 leading-relaxed">
